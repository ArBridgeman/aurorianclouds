...
from sous_chef.date.get_due_date import DEFAULT_TIMEZONE
...
def create_grocery_list_row(
    ...
    for_day: datetime = datetime.datetime(
        year=2022, month=1, day=20, tzinfo=DEFAULT_TIMEZONE
    ),
...
def create_ingredient_and_grocery_entry_raw(
    ...
    for_day: datetime.datetime = datetime.datetime(
        year=2022, month=1, day=27, tzinfo=DEFAULT_TIMEZONE
    ),
    for_day_str: str = "Thu",
...
class TestGroceryList:
    ...
    @pytest.mark.parametrize(
        ...
        [
            (  # Monday
                datetime.datetime(
                    year=2022, month=1, day=24, tzinfo=DEFAULT_TIMEZONE
                ),
                "vegetables",
            ...
            (
                datetime.datetime(
                    year=2022, month=1, day=21, tzinfo=DEFAULT_TIMEZONE
                ),
                "vegetables",
                datetime.date(year=2022, month=1, day=20),
            ),  # Friday
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (
                ...
                datetime.datetime(
                    year=2022, month=1, day=25, hour=12, tzinfo=DEFAULT_TIMEZONE
                ),
            ),
        ],
    )
    ...
    def test__defrost(self, grocery_list, config_grocery_list):
        ...
        assert_equal_dataframe(
            ...
            self._get_preparation_queue(
                ...
                due_date=datetime.datetime(
                    year=2022, month=1, day=26, tzinfo=DEFAULT_TIMEZONE
                ),
            ),
        )
