...
ALLOWED_QUANTULUM = ["cup", "dimensionless", "teaspoon", "tablespoon", "pound-mass", "pound sterling",
                     "penny inch", "speed of light", "inch set", "second of arc", "inch", "ounce", "gram",
                     "kilogram", "drop", "cubic centimetre", "tesla", "centimetre", "pint", "quart", "gallon", "litre"]
...
def separate_quantity_unit_ingredient(ingredient_line):
    ...
    if len(unit) > 0 and unit[0].unit.name in ALLOWED_QUANTULUM:
