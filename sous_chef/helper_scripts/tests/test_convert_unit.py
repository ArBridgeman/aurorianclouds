...
from convert_unit import convert_to_desired_unit, convert_quantity_unit, format_significant_quantity, \
    separate_quantity_unit_ingredient


@pytest.mark.parametrize("quantity, unit, expected_result",
                         [(1, "cup", "1 cup"),
                          (0.25, "tsp", "0.25 tsp")])
...
@pytest.mark.parametrize("input_unit,expected_unit",
                         [("1 cup milk", "1 cup milk"),
                          ...
                          ("1 inch piece of ginger peeled and chopped", "1 inch of ginger peeled and chopped"),
