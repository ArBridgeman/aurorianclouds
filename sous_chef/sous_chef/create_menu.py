...
from filter_recipes import create_previously_tried_filter, create_protein_filter, create_time_filter, \
    has_recipe_category_or_tag, skip_protein_filter, create_tags_or_filter
...
def select_food_item(recipes, params, tags=[], food_type: str = "Entree", cuisine_select=None):
...
def select_side(recipes, calendar, params, recipe_uuid, cuisine_select):
    ...
    if isinstance(veggie_side, pd.DataFrame):
        ...
        return select_food_item(recipes, params, ["veggies"], food_type="Side", cuisine_select=cuisine_select)
